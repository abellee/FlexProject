package com.sina.microblog.data
{
	...
	public class MicroBlogDirectMessage
	{
		 ...
		 * @private
		 */ 
		public function MicroBlogDirectMessage()
		{
			
		}
		public function serialization(message:XML):void
		{
			...
			sender = new MicroBlogUser();
			sender.serialization(message.sender[0]);
			recipient = new MicroBlogUser();
			recipient.serialization(message.recipient[0]);
		}
